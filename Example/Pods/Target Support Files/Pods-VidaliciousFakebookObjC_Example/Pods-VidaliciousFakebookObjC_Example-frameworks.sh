...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ARSegmentPager/ARSegmentPager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EasyFoundation/EasyFoundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EasyReact/EasyReact.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EasySequence/EasySequence.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EasyTuple/EasyTuple.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GreedoLayout/GreedoLayout.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Ophiuchus/Ophiuchus.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PYSearch/PYSearch.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PromisesObjC/FBLPromises.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Pull-to-Refresh.Rentals-IOS/Pull_to_Refresh_Rentals_IOS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PureLayout/PureLayout.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RACollectionViewReorderableTripletLayout/RACollectionViewReorderableTripletLayout.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TimesSquare/TimesSquare.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VidaliciousFakebookObjC/VidaliciousFakebookObjC.framework"
