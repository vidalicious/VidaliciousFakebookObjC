//
//  VFOGCDViewController.m
//  VidaliciousFakebookObjC
//
//  Created by vidalicious on 2019/5/6.
//  Copyright © 2019 vidalicious. All rights reserved.
//

#import "VFOGCDViewController.h"

@interface VFOGCDViewController ()

@end

@implementation VFOGCDViewController
...
- (void)dispatchSetTargetQueueDemo {
    dispatch_queue_t serialQueue = dispatch_queue_create("vidaliciousfackbookobjc.gcddemo.serialqueue", DISPATCH_QUEUE_SERIAL);
    dispatch_queue_t firstQueue = dispatch_queue_create("vidaliciousfackbookobjc.gcddemo.firstqueue", DISPATCH_QUEUE_SERIAL);
    dispatch_queue_t secondQueue = dispatch_queue_create("vidaliciousfackbookobjc.gcddemo.secondqueue", DISPATCH_QUEUE_CONCURRENT);
...
- (void)dispatchBarrierAsyncDemo {
    ...
    dispatch_queue_t dataQueue = dispatch_queue_create("vidaliciousfackbookobjc.gcddemo.dataqueue", DISPATCH_QUEUE_CONCURRENT);
...
- (void)dispatchApplyDemo {
    dispatch_queue_t concurrentQueue = dispatch_queue_create("vidaliciousfackbookobjc.gcddemo.concurrentqueue", DISPATCH_QUEUE_CONCURRENT);
